...
4. Ask it to connect ports using catalog port ids.
5. Ask it to validate the result.
6. Ask it to render a PNG preview.
...
exports/agent-preview.png. Then summarize the created nodes, edges, validation
result and PNG path.
```
...
After rendering, explain which connections were created and mention any
validation errors.
```
